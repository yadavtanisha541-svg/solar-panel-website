...
<section class="hero-section">
    ...
    <div class="container-fluid px-4 px-lg-5 position-relative" style="z-index: 3;">
        <div class="row">
            <div class="col-lg-8 text-start" data-aos="fade-right">
                ...
                <div class="d-flex align-items-center gap-3 mt-4">
                    <a href="<?php echo SITE_URL; ?>/contact.php" class="btn btn-solar-primary btn-lg px-4 py-3 font-weight-bold rounded-2">
                        Contact Us Today <i class="fa-solid fa-arrow-right ms-2"></i>
                    </a>
                    <button class="btn btn-solar-outline text-white border-white btn-lg px-4 py-3 font-weight-bold rounded-2" data-bs-toggle="modal" data-bs-target="#siteSurveyModal">
                        Book Free Survey <i class="fa-solid fa-calendar-check ms-2"></i>
                    </button>
                </div>
            </div>
        </div>
